...
class CabDriver():
    ...
    def reward_func(self, state, action, Time_matrix):
        ...
        if action == (0,0):
            ...
            #print("Time_matrix[action[0]][action[1]][pickuptime][pickupday]: ", Time_matrix[action[0]][action[1]][pickuptime][pickupday])
            #print("Time_matrix[state[0]][action[0]][state[1]][state[2]]:", Time_matrix[state[0]][action[0]][state[1]][state[2]])
            #print("reward:",reward)
        return reward
